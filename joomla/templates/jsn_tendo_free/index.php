	...
	?>
		...
		<?php
			foreach ($this->mainColumns AS $id => $class) {
				if ($id == 'content') {
		?>
				<div id="jsn-maincontent" class="<?php echo $class['span']; ?> <?php echo $class['order']; ?> <?php echo $class['offset']; ?> row-fluid"><div id="jsn-maincontent_inner">
		<?php
		...
		?>
			...
			?>
				<div id="jsn-usermodules3" class="jsn-modulescontainer jsn-modulescontainer<?php echo $this->helper->countPositions('user5', 'user6', 'user7'); ?>"><div id="jsn-pos-usermodules3" class="row-fluid">
			<?php
		...
		?>
			<div id="jsn-footer">
				<div id="jsn-footermodules" class="jsn-modulescontainer jsn-modulescontainer<?php echo $grid_suffix; ?>"><div id="jsn-pos-footermodules" class="row-fluid">
			<?php
