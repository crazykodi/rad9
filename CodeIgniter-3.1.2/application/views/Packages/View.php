...
<body>
	<script>
		...
		function modal(id) {
			...
			var url = "<?php echo site_url('Packages/PackagesController/deleteRecord/'); ?>" + id;
	...
	<h1 class="w3-padding w3-deep-purple">Packages</h1>

	<div class="w3-container w3-padding w3-row ">
		<form class="w3-left w3-third"  method="get" action="<?php echo site_url('Packages/PackagesController/search'); ?> ">
			<input class="w3-input w3-col m8 w3-card"  type="text" name="searchText" placeholder="Enter package name..." value="<?php echo (isset($task) ? $searchText : ''); ?>" required>
			&nbsp;
			<input type="hidden" name="task" value="search">
			<input class="w3-btn w3-padding" type="submit" value="search">
		</form>
		<div  class="w3-right">
			<button class="w3-btn w3-blue w3-padding" onclick="location.href = '<?php echo site_url("Packages/PackagesController/addRecord"); ?>'; ">Add new package</button>
			&nbsp;
			<button class="w3-btn w3-padding" onclick="location.href = '<?php echo site_url("Packages/PackagesController"); ?>'; ">Refresh</button>
		</div>
	...
	?>		
					...
					<td><a href='<?php echo site_url("Packages/PackagesController/editRecord/"), $row->id ?>'> <button class='w3-btn w3-amber'>Edit</button> </a></td>
